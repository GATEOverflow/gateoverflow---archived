...
import org.gateoverflow.q2android.authentication.AccountGeneral;
import org.gateoverflow.q2android.interfaces.*;
...
public class Q2Android extends SherlockListActivity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
        ...
        answerWebView = (WebView) findViewById(R.id.answerWebView);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case (int)R.id.menuNew:
                ...
                button2 = (Button) questionLayout.findViewById(R.id.button2);
                ...
                button3 = (Button) questionLayout.findViewById(R.id.button3);
                ...
                button4 = (Button) questionLayout.findViewById(R.id.button4);
                ...
                edit = (EditText) questionLayout.findViewById(R.id.edit);

                newText1 = (TextView) questionLayout.findViewById(R.id.newText1);
                newText2 = (TextView) questionLayout.findViewById(R.id.newText2);

                w = (WebView) questionLayout.findViewById(R.id.webview);
	...
	private void addAnswers(Object[] answers, final int questionId) {
		for(Object obj : answers) {
			if(obj instanceof HashMap) {
                ...
                final WebView answeredWebView = (WebView) answerView.findViewById(R.id.answerWebView);
			...
			abutton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(final View v) {
					if(rawMap.get("basetype").equals("Q")) {
                        ...
                        final EditText e = (EditText) questionLayout.findViewById(R.id.edit);
                        ...
                        final WebView webview = (WebView) questionLayout.findViewById(R.id.webview);
                        webview.getSettings().setJavaScriptEnabled(true);
                        webview.loadUrl("file:///android_asset/MathJax/index.html");

                        final Button button2 = (Button) questionLayout.findViewById(R.id.button2);
                        button2.setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick(View v) {
                        ...
                        final Button button3 = (Button) questionLayout.findViewById(R.id.button3);
                        button3.setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                e.setText("");
                        ...
                        Button button4 = (Button) questionLayout.findViewById(R.id.button4);
